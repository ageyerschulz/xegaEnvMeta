...
#' Aggregate files of UPCReporter.
#'
...
#'@importFrom stats sd
#'@export
aggregateUPCMetaResults<-function(pattern)
{
...
#'
#' @export
convertUPCMetaResults<-function(l)
{
# extract all fields of the same type.
...
cn<-c(cn, "popsize", "generations", "mutrate", "bitmutrate", "crossrate", "uCrossSwap")
