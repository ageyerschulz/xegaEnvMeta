...
#' Factory for optimizing parameters of a binary GA with IV mutation operator.
#'
...
#' stepsT<-15
#' path<-xegaTmpDir()
#' IV<-IVmmetaGAFactory(EnvList, name="IVShekel5d", 
...
#' @export
IVmmetaGAFactory<-function(envList, 
